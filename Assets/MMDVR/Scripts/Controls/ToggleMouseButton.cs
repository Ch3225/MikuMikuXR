...
namespace MMDVR.Scripts.Controls
{
    ...
    public class ToggleMouseButton : MonoBehaviour
    {
        ...
        [SerializeField] private FreeCameraController cameraController; // 摄像机控制器
        ...
        void Start()
        {
            ...
            {
                cameraController = freeCamera.GetComponent<FreeCameraController>();
            }
        }        void Update()
        {
        ...
        }        private void ToggleMouseMode()
        {
            if (freeCamera != null && freeCamera.activeInHierarchy)
            {
                ...
                {
                    cameraController.SetControlMode(isToggleMode ? FreeCameraController.ControlMode.Always : FreeCameraController.ControlMode.RightClickOnly);
